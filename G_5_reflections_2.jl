...
print(rad_test_delta_21 == test_delta_21);  # Returns true and thus shows that the ideal is radical, so the blowup is indeed computed in the associated variety
...
W_delta_11_delta_21 = preimage(pi_1, delta_11_delta_21_ideal);
...
print(W_Berry_ideal == W_delta_11_prime + relations_ideal);  # Returns false
print(W_Berry_ideal == W_delta_21_prime + relations_ideal);  # Returns false
print(W_Berry_ideal == W_delta_11_delta_21_prime + relations_ideal);  # Returns false
