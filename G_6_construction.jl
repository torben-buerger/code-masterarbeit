...
print(rad_test_delta_22 == test_delta_22);  # Returns false, however, comparing with quo_W_delta_21 gives a true, so the varieties in which we will blowup coincide
...
nonzero_quo_W_delta_11_21 = gens(quo_basis_W_delta_11_21)[[3; 7:11; 19:31]];
test_delta_11_21 = ideal(S_quo, nonzero_quo_W_delta_11_21)[[1:2,; 4:6; 11; 14; 16]];
print(test_delta_11_21 == quo_W_delta_11_21);  # Returns true, therefore, the ideal image of W_delta_11_21 in the quotient ring is generated by 8 nonzero elements of the basis
rad_test_delta_11_21 = radical(test_delta_11_21);
print(rad_test_delta_11_21 == test_delta_11_21);
...
nonzero_quo_W_delta_11_22 = gens(quo_basis_W_delta_11_22)[[8; 18:19; 21; 24:31]];
test_delta_11_22 = ideal(S_quo, nonzero_quo_W_delta_11_22)[[1; 3:9]];
print(test_delta_11_22 == quo_W_delta_11_22);  # Returns true, therefore, the ideal image of W_delta_11_21 in the quotient ring is generated by 8 nonzero elements of the basis
rad_test_delta_11_22 = radical(test_delta_11_22);
print(rad_test_delta_11_22 == test_delta_11_22);
