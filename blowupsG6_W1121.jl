...
# Define the genarators of the ideal W_delta_11_21 in which we want to compute the blowup via the Rees algebra
...
Rees_basis_11_21 = standard_basis(Rees_rel_11_21, ordering=negdegrevlex(Aux_large_D));  # Get a smaller generating set of the blowup ideal
Rees_basis_ideal_11_21 = ideal(Aux_large_D, Rees_basis_11_21);
